export class CustomerMasterApiUrls {
  public static readonly CreateCustomerMaster = "/CustomerMaster/CreateCustomerWithKYC";
  public static readonly GetAllCustomerDetails = "/CustomerMaster/GetAllCustomerDetails";
